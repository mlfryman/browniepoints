...
module.exports = [
  ...
  // {method: 'PUT',    path: '/friends/{friendId}/accept',    config: require('../definitions/friendships/update_accept_friend')},
  // {method: 'PUT',    path: '/friends/{friendId}/deny',      config: require('../definitions/friendships/update_deny_friend')}
];
