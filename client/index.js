  ...
  angular.module('browniepoints', ['ui.router', 'angularFileUpload'])
    .config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider){
      ...
      $stateProvider
        ...
        .state('friends.list',    {url:'',                 templateUrl:'/views/friends/friends_list.html',     controller:'FriendsListCtrl'})
        .state('friends.detail',  {url:'/{friendshipId}',  templateUrl:'/views/friends/friends_detail.html',   controller:'FriendsDetailCtrl'});
    }])
